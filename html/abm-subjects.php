          ...
          <!-- / Staffs -->
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    // Fetch the total number of rows for ABM Subjects
                    $totalABMRowsQuery = "SELECT COUNT(*) AS total FROM subjects WHERE strand = 'ABM'";
                    $totalABMRowsResult = $conn->query($totalABMRowsQuery);
                    $totalABMRows = $totalABMRowsResult->fetch_assoc()['total'];

                    // Calculate the total number of pages for ABM Subjects
                    $totalABMPages = ceil($totalABMRows / $rowsPerPage);

                    // Fetch the rows for ABM Subjects
                    $abmQuery = "SELECT subject_code, subject_name FROM subjects WHERE strand = 'ABM' LIMIT $rowsPerPage OFFSET $offset";
                    $abmResult = $conn->query($abmQuery);
                    ?>
                        ...
                        <div class="card">
                            ...
                            <div class="table-responsive text-nowrap">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                        if ($abmResult->num_rows > 0) {
                                            while ($row = $abmResult->fetch_assoc()) {
                                                echo "<tr>";
                                                echo "<td>" . $row['subject_code'] . "</td>";
                                                echo "<td>" . $row['subject_name'] . "</td>";
                                                echo "<td>
                            ...
                            <!-- Pagination for ABM Subjects -->
                            <nav aria-label="ABM Subjects Pagination">
                                <ul class="pagination justify-content-center mt-3">
                                    <?php if ($page > 1): ?>
                                        <li class="page-item">
                                            <a class="page-link" href="?page=<?php echo $page - 1; ?>" aria-label="Previous">
                                    ...
                                    <?php for ($i = 1; $i <= $totalABMPages; $i++): ?>
                                        <li class="page-item <?php echo ($i == $page) ? 'active' : ''; ?>">
                                            <a class="page-link" href="?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                                        </li>
                                    <?php endfor; ?>

                                    <?php if ($page < $totalABMPages): ?>
                                        <li class="page-item">
                                            <a class="page-link" href="?page=<?php echo $page + 1; ?>" aria-label="Next">
                                                <span aria-hidden="true">&raquo;</span>
                                            </a>
