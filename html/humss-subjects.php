          ...
          <!-- / Staffs -->
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    // Fetch the total number of rows for HUMSS Subjects
                    $totalHUMSSRowsQuery = "SELECT COUNT(*) AS total FROM subjects WHERE strand = 'HUMSS'";
                    $totalHUMSSRowsResult = $conn->query($totalHUMSSRowsQuery);
                    $totalHUMSSRows = $totalHUMSSRowsResult->fetch_assoc()['total'];

                    // Calculate the total number of pages for HUMSS Subjects
                    $totalHUMSSPages = ceil($totalHUMSSRows / $rowsPerPage);

                    // Fetch the rows for HUMSS Subjects
                    $humssQuery = "SELECT subject_code, subject_name FROM subjects WHERE strand = 'HUMSS' LIMIT $rowsPerPage OFFSET $offset";
                    $humssResult = $conn->query($humssQuery);
                    ?>
                        ...
                        <div class="card">
                            ...
                            <div class="table-responsive text-nowrap">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                        if ($humssResult->num_rows > 0) {
                                            while ($row = $humssResult->fetch_assoc()) {
                                                echo "<tr>";
                                                echo "<td>" . $row['subject_code'] . "</td>";
                                                echo "<td>" . $row['subject_name'] . "</td>";
                                                echo "<td>
                            ...
                            <!-- Pagination for HUMSS Subjects -->
                            <nav aria-label="HUMSS Subjects Pagination">
                                <ul class="pagination justify-content-center mt-3">
                                    <?php if ($page > 1): ?>
                                        <li class="page-item">
                                            <a class="page-link" href="?page=<?php echo $page - 1; ?>" aria-label="Previous">
                                    ...
                                    <?php for ($i = 1; $i <= $totalHUMSSPages; $i++): ?>
                                        <li class="page-item <?php echo ($i == $page) ? 'active' : ''; ?>">
                                            <a class="page-link" href="?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                                        </li>
                                    <?php endfor; ?>

                                    <?php if ($page < $totalHUMSSPages): ?>
                                        <li class="page-item">
                                            <a class="page-link" href="?page=<?php echo $page + 1; ?>" aria-label="Next">
                                                <span aria-hidden="true">&raquo;</span>
                                            </a>
