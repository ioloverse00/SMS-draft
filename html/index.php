...
<body>
  ...
  <div class="layout-wrapper layout-content-navbar">
            ...
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="parents.php" class="menu-link">
                  <div data-i18n="Connections">Parents Account</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="teachers.php" class="menu-link">
                  <div data-i18n="Notifications">Teachers Account</div>
                </a>
              </li>
            </ul>
          </li>
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row">
                  ...
                  <div class="d-flex align-items-end row">
                    <div class="col-sm-7">
                      <div class="card-body">
                        ...
                        <p class="mb-4">
                          Achieve your goals, enjoy the process, and spread positivity! Hard work shines brighter when you <span class="fw-bold">wear a smile!</span>
                        </p>
                      </div>
                    </div>
                  ...
                  <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <h3 class="card-title mb-2"><?php echo $total_parents; ?></h3>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                      <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                          <div class="avatar flex-shrink-0">
                            <i class="bx bxs-chalkboard text-info fs-1"></i>
                          </div>
                          <div class="dropdown">
                        ...
                        <span>Teachers</span>
                        <h3 class="card-title text-nowrap mb-1"><?php echo $total_teachers; ?></h3>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4">
                <div class="card">
                  <h5 class="card-header m-0 me-2 pb-3">Students Statistics</h5>
                  <div id="totalRevenueChart" class="p-1"></div>
                </div>
              </div>
              <!--/ Total Revenue -->
                  ...
                  <div class="col-12 mb-4">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <h3 class="card-title text-nowrap mb-2"><?php echo $total_students; ?></h3>
                      </div>
                    </div>
                  </div>
                  <!-- </div>
    <div class="row"> -->
                  <div class="col-12 mb-4">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <h3 class="card-title text-nowrap mb-2"><?php echo $total_users; ?></h3>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="row">
              <!-- Order Statistics -->
              <div class="col-md-6 col-lg-4 col-xl-5 order-0 mb-4">
                <div class="card h-100">
                  <div class="card-header d-flex align-items-center justify-content-between pb-0">
                    <div class="card-title mb-0">
                      <h5 class="m-0 me-2">Strand Statistics</h5>
                      <small class="text-muted">Year <?php echo $current_year; ?></small>
                    </div>
                    <div class="dropdown">
                      <button
                        class="btn p-0"
                  ...
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                      <div class="d-flex flex-column align-items-center gap-1">
                        <h2 class="mb-2"><?php echo $total_students_current_year; ?></h2>
                    ...
                    <ul class="p-0 m-0">
                      <li class="d-flex mb-4 pb-1">
                        ...
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                          <div class="me-2">
                            <h6 class="mb-0">ABM</h6>
                            <small class="text-muted">Accountancy, Business, Management</small>
                          </div>
                          <div class="user-progress">
                            <small class="fw-semibold"><?php echo $total_students_abm; ?></small>
                          </div>
                        </div>
                      </li>
                      <li class="d-flex mb-4 pb-1">
                        <div class="avatar flex-shrink-0 me-3">
                          <span class="avatar-initial rounded bg-label-success"><i class="bx bx-bong"></i></span>
                        </div>
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                          <div class="me-2">
                            <h6 class="mb-0">STEM</h6>
                            <small class="text-muted">Science, Technology, Engineering, Mathematics</small>
                          </div>
                          <div class="user-progress">
                            <small class="fw-semibold"><?php echo $total_students_stem; ?></small>
                          </div>
                        </div>
                      </li>
                      <li class="d-flex mb-4 pb-1">
                        ...
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                          <div class="me-2">
                            <h6 class="mb-0">HUMSS</h6>
                            <small class="text-muted">Humanities & Social Sciences</small>
                          </div>
                          <div class="user-progress">
                            <small class="fw-semibold"><?php echo $total_students_humss; ?></small>
                          </div>
                        </div>
                      </li>
                      <li class="d-flex">
                        <div class="avatar flex-shrink-0 me-3">
                          <span class="avatar-initial rounded bg-label-secondary"><i class="bx bx-desktop"></i></span>
                        </div>
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                          <div class="me-2">
                            <h6 class="mb-0">ICT</h6>
                            <small class="text-muted">Information & Communication Technology</small>
                          </div>
                          <div class="user-progress">
                            <small class="fw-semibold"><?php echo $total_students_ict; ?></small>
                          </div>
                        </div>
                      </li>
                    </ul>
                      ...
                      <?php foreach ($activity_log as $activity): ?>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                          <div class="d-flex align-items-center">
                            <div class="avatar flex-shrink-0 me-3">
                              <span class="avatar-initial rounded-circle <?php echo $activity['badge_color']; ?>">
                                <i class="bx bx-info-circle"></i>
                              </span>
                            </div>
                            <div>
                              <h6 class="mb-0"><?php echo $activity['activity_type']; ?></h6>
                              <small class="text-muted"><?php echo $activity['description']; ?></small>
                            </div>
                          </div>
                          <span class="badge <?php echo $activity['badge_color']; ?> rounded-pill">
