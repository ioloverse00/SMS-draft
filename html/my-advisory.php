...
// Fetch the section name for the logged-in adviser
$sectionQuery = "SELECT section_name FROM sections WHERE adviser_id = '$user_id'";
...
if ($sectionResult && $sectionResult->num_rows > 0) {
    ...
    $sectionName = "No advisory section assigned.";
}
?>
<!DOCTYPE html>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4">Advisory Class</h4>
                        <!-- Classes Table -->
                        <div class="card mb-4">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5 class="mb-0"><?php echo $sectionName; ?></h5>
                            </div>
                            <div class="table-responsive text-nowrap">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                        // Query to fetch students in the advisory section with parent name and phone
                                        $studentsQuery = "
                SELECT s.student_id, s.last_name, s.first_name, s.middle_name,
                    CONCAT(u.first_name, ' ', u.last_name) AS parent_name,
                    u.phone AS parent_phone
                FROM students s
                LEFT JOIN users u ON s.parent_id = u.user_id AND u.role = 'Parent'
                WHERE s.section_id = (SELECT section_id FROM sections WHERE section_name = '$sectionName')
            ";
                                        ...
                                        if ($studentsResult && $studentsResult->num_rows > 0) {
                                            while ($student = $studentsResult->fetch_assoc()) {
                                                ...
                                                echo "<td>" . htmlspecialchars($student['parent_phone']) . "</td>";
                                                echo "</tr>";
                                            }
                                        } else {
                                            echo "<tr><td colspan='6' class='text-center'>No students found in this section.</td></tr>";
                                        }
                                        ?>
                                    </tbody>
                                </table>
