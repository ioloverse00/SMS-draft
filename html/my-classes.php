            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4">Assigned Classes/Sections</h4>
                        <!-- Classes Table -->
                        <div class="card mb-4">
                                    ...
                                    <tbody>
                                        ...
                                        if ($classesResult->num_rows > 0) {
                                            while ($row = $classesResult->fetch_assoc()) {
                                                $link = "students.php?section_id=" . $row['section_id'] . "&subject_code=" . $row['subject_code'];
                                                echo "<tr class='clickable-row' data-href='$link'>";
                                            ...
                                            echo "<tr><td colspan='3' class='text-center'>No classes assigned.</td></tr>";
                                        }
                                        ?>
                                    </tbody>
                                </table>
