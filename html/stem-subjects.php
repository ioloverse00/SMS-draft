          ...
          <!-- / Staffs -->
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    // Fetch the total number of rows for STEM Subjects
                    $totalSTEMRowsQuery = "SELECT COUNT(*) AS total FROM subjects WHERE strand = 'STEM'";
                    $totalSTEMRowsResult = $conn->query($totalSTEMRowsQuery);
                    $totalSTEMRows = $totalSTEMRowsResult->fetch_assoc()['total'];

                    // Calculate the total number of pages for STEM Subjects
                    $totalSTEMPages = ceil($totalSTEMRows / $rowsPerPage);

                    // Fetch the rows for STEM Subjects
                    $stemQuery = "SELECT subject_code, subject_name FROM subjects WHERE strand = 'STEM' LIMIT $rowsPerPage OFFSET $offset";
                    $stemResult = $conn->query($stemQuery);
                    ?>
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card">
                            ...
                            <!-- Pagination for STEM Subjects -->
                            <nav aria-label="STEM Subjects Pagination">
                                <ul class="pagination justify-content-center mt-3">
                                    <?php if ($page > 1): ?>
                                        <li class="page-item">
                                            <a class="page-link" href="?page=<?php echo $page - 1; ?>" aria-label="Previous">
                                    ...
                                    <?php for ($i = 1; $i <= $totalSTEMPages; $i++): ?>
                                        <li class="page-item <?php echo ($i == $page) ? 'active' : ''; ?>">
                                            <a class="page-link" href="?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                                        </li>
                                    <?php endfor; ?>

                                    <?php if ($page < $totalSTEMPages): ?>
                                        <li class="page-item">
                                            <a class="page-link" href="?page=<?php echo $page + 1; ?>" aria-label="Next">
                                                <span aria-hidden="true">&raquo;</span>
                                            </a>
