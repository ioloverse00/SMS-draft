            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><?php echo htmlspecialchars($subject_name); ?></h4>
                        <!-- Classes Table -->
                        <div class="card mb-4">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5 class="mb-0"><?php echo htmlspecialchars($section_name); ?> | Students</h5>
                                <button 
                                    class="btn btn-sm btn-success" 
                                    onclick="window.location.href='attendance.php?subject_code=<?php echo urlencode($subject_code); ?>&section_name=<?php echo urlencode($section_name); ?>'">
                                    Attendance
                                </button>
                            </div>
                            <div class="table-responsive text-nowrap">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT students.student_id, students.first_name, students.last_name, students.middle_name 
                                                  FROM students 
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<tr class='clickable-row' data-href='student-performance.php?student_id=" . urlencode($student_id) . "&subject_code=" . urlencode($subject_code) . "'>";
