            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4">Grade 12 Enrolees</h4>
                        <div class="card">
                                    ...
                                    <form id="addStudentForm" method="POST" action="add_student.php">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="addStudentSection" name="addStudentSection" required>
                                                ...
                                                // Fetch sections with grade level 12
                                                $sectionQuery = "
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="hidden" name="grade_level" value="12">
                                        </div>
